...
class ccpOAuth {
    ...
    function getToken($authCode,$refresh=false){
        if(session_status() == PHP_SESSION_ACTIVE &&isset($_SESSION['CCP']['access']['access_token'])&&isset($_SESSION['CCP']['access'])&&($_SESSION['CCP']['access']['expires']>time())){
    ...
    function getUserInfo($token){
        if(isset($_SESSION['CCP']['user'])&&($_SESSION['CCP']['access']['expires']>time())){
            return $_SESSION['CCP']['user']['CharacterID'];
